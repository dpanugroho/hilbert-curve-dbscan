...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("MedoidPointIndexList=> "+hilbertProcess.getMedoidPointIndexList(hilbertProcess.clusterAdjacentCell(numberOfCellPoints), indexOfCoordinates));
